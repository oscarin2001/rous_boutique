  ...
  return (
    <div className="space-y-5">
      <div className="rounded-xl bg-card/80 p-4 shadow-sm ring-1 ring-border/40">
        ...
        <p className="mb-3 text-xs text-muted-foreground">Esta seccion administra cuentas con nivel superadmin. El alta requiere confirmacion con contrasena actual.</p>
